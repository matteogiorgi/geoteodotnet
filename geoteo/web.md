...
> We already know what could happend if a fool types [google into google](https://www.youtube.com/watch?v=v2FMqtC1x9Y), but what happens behind the scenes when we type google.com in a browser? (This is just a rewrite of [`how-web-works`](https://github.com/vasanthk/how-web-works) by [vasanthk](https://www.vasanthk.com)).
...
Concatenating the three numbers a-b-c-d (in a number system with a large base) gives the specificity. The number base you need to use is defined by the highest count you have in one of a, b, c and d (examples).
