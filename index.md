...
[This](https://github.com/MatteoGiorgi/asteroids_plus_plus) one is a replica (with few additions) and it is written in JavaScript using [P5.js](https://p5js.org/) libraries; [play](https://matteogiorgi.github.io/asteroids_plus_plus/src) with it using `w`, `a`, `d` to move around and `spc`, `m` to fire and drop bombs.
